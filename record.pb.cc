...
const uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, typeofactivity_),
  PROTOBUF_FIELD_OFFSET(::Company, foreign_),
  0,
  3,
  1,
  2,
...
const char descriptor_table_protodef_record_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\014\n\004year\030\002 \002(\005\022\024\n\014legalAddress\030\003 \002(\t\022\026\n\016t"
  "ypeOfActivity\030\004 \001(\t\022\017\n\007foreign\030\005 \001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_record_2eproto = {
  false, false, 116, descriptor_table_protodef_record_2eproto, "record.proto", 
...
Company::Company(const Company& from)
  ...
  ::memcpy(&year_, &from.year_,
    ...
    reinterpret_cast<char*>(&year_)) + sizeof(foreign_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Company.typeOfActivity");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreign(), target);
  }
